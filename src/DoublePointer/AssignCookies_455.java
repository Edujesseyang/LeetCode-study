    ...
    */
    ...
    public static int findContentChildren1(int[] g, int[] s) {
        ...
        while (i < g.length && j < s.length) {
            ...
            count = j < s.length ? count + 1 : count;
            i++;
            j++;
        }
        return count;
